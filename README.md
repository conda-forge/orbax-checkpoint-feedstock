About orbax-checkpoint-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/orbax-checkpoint-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/orbax-checkpoint-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add orbax-checkpoint
# for installing globally
pixi global install orbax-checkpoint
```
...
It is possible to list all of the versions of `orbax-checkpoint` available on your platform:
...
```
pixi search orbax-checkpoint --channel conda-forge
```
